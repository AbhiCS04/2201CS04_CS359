    ...
    def get(self):
        ...
        try:
            with db_lock:
                ...
                # Add file type filter if provided and not "All"
                if file_type and file_type != "all":
                    sql += " AND LOWER(f.file_type) = ?"
            ...
            logging.info(f"Search performed: query='{query}', file_type='{file_type}', Found {len(files)} files.")
